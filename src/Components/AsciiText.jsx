...
class AsciiFilter {
    ...
    onMouseMove(e) {
        ...
        const x = (e.clientX - bounds.left) * PX_RATIO;
        const y = (e.clientY - bounds.top) * PX_RATIO;
        this.mouse = { x, y };
    }
        ...
        const setup = async () => {
            ...
            if (width === 0 || height === 0) {
                ...
                if (pRect.width > 0 && pRect.height > 0) {
                     asciiRef.current = await createAndInit(containerRef.current, pRect.width, pRect.height);
